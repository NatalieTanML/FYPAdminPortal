          ...
          <b-row class="bg-white text-left" align-h="center">
            <b-col cols="8" class="my-5">
              ...
              <b-form class="resource-form">
                ...
                >
                  <b-form-input id="productId"></b-form-input>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  label-for="input-horizontal"
                >
                  <b-form-input id="productName"></b-form-input>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  label-for="input-horizontal"
                >
                  <b-form-textarea id="description" rows="6"></b-form-textarea>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  label-for="input-horizontal"
                >
                  <b-form-input id="currentQuantity"></b-form-input>
                </b-form-group>
