              ...
              <b-form class="resource-form">
                ...
                >
                  <b-form-textarea
                    id="description"
                    rows="6"
                    value="Customise your keychain with your loved ones!"
                  ></b-form-textarea>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  label-for="input-horizontal"
                >
                  <b-form-input id="variantName" value="Key chain with Frame"></b-form-input>
                </b-form-group>
...
<script>
// 1. Change dropdown to radio buttons (discount)
// 2. Have hints for date
// 3. Include subheading
...
// General, Prices, Images, Varients?
// notification
...
/* https://stackoverflow.com/questions/52770048/change-text-colour-with-bootstrap-vue-navbar-item-dropdown */
