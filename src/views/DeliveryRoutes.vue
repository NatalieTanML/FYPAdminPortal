      ...
      <div id="content">
        ...
        <div id="content">
          <div>
            ...
            ></Table>
            <b-modal @ok="updateDeliveryman()" id="delivery-routes-modal" title="Assign to Deliveryman" ok-title="Save">
...
export default {
  ...
  methods: {
    getRegionByPostalCode(postcode) {
      ...
      if (postcode.substring(0, 2) == "07" || postcode.substring(0, 2) == "08")
        return "Anson, Tanjong Pagar";
      if (postcode.substring(0, 2) == "09" || postcode.substring(0, 2) == "10")
      ...
      if (postcode.substring(0, 2) == "18" || postcode.substring(0, 2) == "19")
        return "Middle Road, Golden Mile";
      if (postcode.substring(0, 2) == "20" || postcode.substring(0, 2) == "21")
        return "Little India";
      if (postcode.substring(0, 2) == "22" || postcode.substring(0, 2) == "23")
      ...
      if (postcode.substring(0, 2) == "51" || postcode.substring(0, 2) == "52")
      ...
      if (postcode.substring(0, 2) == "56" || postcode.substring(0, 2) == "57")
        return "Bishan, Ang Mo Kio";
      if (postcode.substring(0, 2) == "58" || postcode.substring(0, 2) == "59")
      ...
      if (postcode.substring(0, 2) == "72" || postcode.substring(0, 2) == "73")
        return "Kranji, Woodgrove";
      if (postcode.substring(0, 2) == "77" || postcode.substring(0, 2) == "78")
        return "Upper Thomson, Springleaf";
      if (postcode.substring(0, 2) == "75" || postcode.substring(0, 2) == "76")
        return "Yishun, Sembawang";
      if (postcode.substring(0, 2) == "79" || postcode.substring(0, 2) == "80")
        return "Seletar";
