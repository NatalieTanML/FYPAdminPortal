        ...
        <div class="container-fluid" >
          ...
          <div id="content">
            ...
            <div class="row">
              ...
              <DashboardTabs v-for="tab in this.Tabs" v-bind:key="tab.id" v-bind:title="tab.title" v-bind:isDark="tab.isDark"  @click.native="changeBackgroundColor(tab.id)"></DashboardTabs>
              </ul>
            </div>
            </div>
          </div>
